...
class DietaryScoreTestCase(unittest.TestCase):
    def test_from_vioscreen(self):
        exp = VioscreenDietaryScore(sessionId="0087da64cdcb41ad800c23531d1198f2",
                                    scoresType="Hei2010",
                                    scores=[VioscreenDietaryScoreComponent(scoreType="TotalVegetables",
                                                                           name="",
                                                                           score=0,
                                                                           lowerLimit=0,
                                                                           upperLimit=0),
                                            VioscreenDietaryScoreComponent(scoreType="GreensAndBeans",
                                                                           name="",
                                                                           score=0,
                                                                           lowerLimit=0,
                                                                           upperLimit=0),
                                            VioscreenDietaryScoreComponent(scoreType="TotalFruit",
                                                                           name="",
                                                                           score=0,
                                                                           lowerLimit=0,
                                                                           upperLimit=0),
                                            VioscreenDietaryScoreComponent(scoreType="WholeFruit",
                                                                           name="",
                                                                           score=0,
                                                                           lowerLimit=0,
                                                                           upperLimit=0),
                                            VioscreenDietaryScoreComponent(scoreType="WholeGrains",
                                                                           name="",
                                                                           score=0,
                                                                           lowerLimit=0,
                                                                           upperLimit=0),
                                            VioscreenDietaryScoreComponent(scoreType="Dairy",
                                                                           name="",
                                                                           score=0,
                                                                           lowerLimit=0,
                                                                           upperLimit=0),
                                            VioscreenDietaryScoreComponent(scoreType="TotalProteins",
                                                                           name="",
                                                                           score=0,
                                                                           lowerLimit=0,
                                                                           upperLimit=0),
                                            VioscreenDietaryScoreComponent(scoreType="SeafoodAndPlantProteins",
                                                                           name="",
                                                                           score=0,
                                                                           lowerLimit=0,
                                                                           upperLimit=0),
                                            VioscreenDietaryScoreComponent(scoreType="FattyAcids",
                                                                           name="",
                                                                           score=0,
                                                                           lowerLimit=0,
                                                                           upperLimit=0),
                                            VioscreenDietaryScoreComponent(scoreType="RefinedGrains",
                                                                           name="",
                                                                           score=0,
                                                                           lowerLimit=0,
                                                                           upperLimit=0),
                                            VioscreenDietaryScoreComponent(scoreType="Sodium",
                                                                           name="",
                                                                           score=0,
                                                                           lowerLimit=0,
                                                                           upperLimit=0),
                                            VioscreenDietaryScoreComponent(scoreType="EmptyCalories",
                                                                           name="",
                                                                           score=0,
                                                                           lowerLimit=0,
                                                                           upperLimit=0),
                                            VioscreenDietaryScoreComponent(scoreType="TotalScore",
                                                                           name="",
                                                                           score=0,
                                                                           lowerLimit=0,
                                                                           upperLimit=0)
