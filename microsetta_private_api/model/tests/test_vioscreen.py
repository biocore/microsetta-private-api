...
MPEDS_DATA = [
    ...
    {"sessionId": "005eae45652f4aef9880502a08139155",
        "data": [
            {"code": "A_BEV", "description": "MPED: Total drinks of alcohol", "units": "alc_drinks", "amount": 0.0038081095890411, "valueType": "Amount"},
            {"code": "A_CAL", "description": "MPED: Calories from alcoholic beverages", "units": "kcal", "amount": 0.0, "valueType": "Amount"},
            {"code": "ADD_SUG", "description": "MPED: Teaspoon equivalents of added sugars", "units": "tsp_eq", "amount": 1.93501182070685, "valueType": "Amount"},
            {"code": "D_CHEESE", "description": "MPED: Number of cheese cup equivalents", "units": "cup_eq", "amount": 0.380408484438356, "valueType": "Amount"},
            {"code": "D_MILK", "description": "MPED: Number of milk cup equivalents", "units": "cup_eq", "amount": 0.765225735699061, "valueType": "Amount"},
            {"code": "D_TOT_SOYM", "description": "MPED: Total number of milk group (milk, yogurt & cheese) cup equivalents PLUS soy milk", "units": "cup_eq", "amount": 1.14563422013742, "valueType": "Amount"},
            {"code": "D_TOTAL", "description": "MPED: Total number of milk group (milk, yogurt & cheese) cup equivalents", "units": "cup_eq", "amount": 1.14563422013742, "valueType": "Amount"},
            {"code": "D_YOGURT", "description": "MPED: Number of yogurt cup equivalents", "units": "cup_eq", "amount": 0.0, "valueType": "Amount"},
            {"code": "DISCFAT_OIL", "description": "MPED: Grams of discretionary Oil", "units": "g", "amount": 18.6930298301107, "valueType": "Amount"},
            {"code": "DISCFAT_SOL", "description": "MPED: Grams of discretionary Solid fat", "units": "g", "amount": 26.9916611392233, "valueType": "Amount"},
            {"code": "F_CITMLB", "description": "MPED: Number of citrus, melon, berry cup equivalents", "units": "cup_eq", "amount": 0.995266404079452, "valueType": "Amount"},
            {"code": "F_NJ_CITMLB", "description": "MPED: Number of non-juice citrus, melon, berry cup equivalents", "units": "cup_eq", "amount": 0.561270734389041, "valueType": "Amount"},
            {"code": "F_NJ_OTHER", "description": "MPED: Number of other non-juice fruit cup equivalents", "units": "cup_eq", "amount": 0.996097398082192, "valueType": "Amount"},
            {"code": "F_NJ_TOTAL", "description": "MPED: Total number of non-juice fruit cup equivalents", "units": "cup_eq", "amount": 1.55736813247123, "valueType": "Amount"},
            {"code": "F_OTHER", "description": "MPED: Number of other fruit cup equivalents", "units": "cup_eq", "amount": 0.996097398082192, "valueType": "Amount"},
            {"code": "F_TOTAL", "description": "MPED: Total number of fruit cup equivalents", "units": "cup_eq", "amount": 1.99136380216164, "valueType": "Amount"},
            {"code": "G_NWHL", "description": "MPED: Number of non-whole grain ounce equivalents", "units": "oz_eq", "amount": 6.44845701105206, "valueType": "Amount"},
            {"code": "G_TOTAL", "description": "MPED: Total number of grain ounce equivalents", "units": "oz_eq", "amount": 7.09519468776438, "valueType": "Amount"},
            {"code": "G_WHL", "description": "MPED: Number of whole grain ounce equivalents", "units": "oz_eq", "amount": 0.646737676712329, "valueType": "Amount"},
            {"code": "LEGUMES", "description": "MPED: Number of cooked dry beans and peas cup equivalents", "units": "cup_eq", "amount": 0.0424098468493151, "valueType": "Amount"},
            {"code": "M_EGG", "description": "MPED: Oz equivalents of lean meat from eggs", "units": "oz_eq", "amount": 0.78721185810411, "valueType": "Amount"},
            {"code": "M_FISH_HI", "description": "MPED: Oz cooked lean meat from fish, other seafood high in Omega-3", "units": "oz_eq", "amount": 1.03492676940822, "valueType": "Amount"},
            {"code": "M_FISH_LO", "description": "MPED: Oz cooked lean meat from fish, other seafood low in Omega-3", "units": "oz_eq", "amount": 0.857956826482192, "valueType": "Amount"},
            {"code": "M_FRANK", "description": "MPED: Oz cooked lean meat from franks, sausages, luncheon meats", "units": "oz_eq", "amount": 0.211429568032877, "valueType": "Amount"},
            {"code": "M_MEAT", "description": "MPED: Oz cooked lean meat from beef, pork, veal, lamb, and game", "units": "oz_eq", "amount": 0.193701499484932, "valueType": "Amount"},
            {"code": "M_MPF", "description": "MPED: Oz cooked lean meat from meat, poultry, fish", "units": "oz_eq", "amount": 2.80722668171507, "valueType": "Amount"},
            {"code": "M_NUTSD", "description": "MPED: Oz equivalents of lean meat from nuts and seeds", "units": "oz_eq", "amount": 1.09403043311781, "valueType": "Amount"},
            {"code": "M_ORGAN", "description": "MPED: Oz cooked lean meat from organ meats", "units": "oz_eq", "amount": 0.0, "valueType": "Amount"},
            {"code": "M_POULT", "description": "MPED: Oz cooked lean meat from chicken, poultry, and other poultry", "units": "oz_eq", "amount": 0.509212018191781, "valueType": "Amount"},
            {"code": "M_SOY", "description": "MPED: Oz equivalents of lean meat from soy product", "units": "oz_eq", "amount": 0.000516162936986301, "valueType": "Amount"},
            {"code": "rgrain", "description": "Refined Grains (ounce equivalents)", "units": "oz_eq", "amount": 5.61935287671233, "valueType": "Amount"},
            {"code": "tgrain", "description": "Total Grains (ounce equivalents)", "units": "oz_eq", "amount": 7.21108602739726, "valueType": "Amount"},
            {"code": "V_DRKGR", "description": "MPED: Number of dark-green vegetable cup equivalents", "units": "cup_eq", "amount": 0.255037085786301, "valueType": "Amount"},
            {"code": "V_ORANGE", "description": "MPED: Number of orange vegetable cup equivalents", "units": "cup_eq", "amount": 0.439391342465753, "valueType": "Amount"},
            {"code": "V_OTHER", "description": "MPED: Number of other vegetable cup equivalents", "units": "cup_eq", "amount": 0.856431346252055, "valueType": "Amount"},
            {"code": "V_POTATO", "description": "MPED: Number of white potato cup equivalents", "units": "cup_eq", "amount": 0.22258482418773, "valueType": "Amount"},
            {"code": "V_STARCY", "description": "MPED: Number of other starchy vegetable cup equivalents", "units": "cup_eq", "amount": 0.00236117671232877, "valueType": "Amount"},
            {"code": "V_TOMATO", "description": "MPED: Number of tomato cup equivalents", "units": "cup_eq", "amount": 0.0487311044219178, "valueType": "Amount"},
            {"code": "V_TOTAL", "description": "MPED: Total number of vegetable cup equivalents, excl legumes", "units": "cup_eq", "amount": 1.82454042770554, "valueType": "Amount"},
            {"code": "wgrain", "description": "Whole Grains (ounce equivalents)", "units": "oz_eq", "amount": 1.59173315068493, "valueType": "Amount"}
        ]
    }
]
