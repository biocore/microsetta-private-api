...
HUMAN_SITE_INVARIANTS = {
    ...
    'Sole of foot': {
        ...
        'host_body_site': 'UBERON:skin of foot'},
    'Nasal mucus': {
        'host_body_product': 'UBERON:mucus',
        'sample_type': 'Mucus',
        'scientific_name': 'human nasal/pharyngeal metagenome',
        ...
        'host_body_site': 'UBERON:nostril'},
    'Stool': {
        'host_body_product': 'UBERON:feces',
        'sample_type': 'Stool',
    ...
    'Tears': {
        'host_body_product': 'UBERON:tears',
        'sample_type': 'Tears',
        'scientific_name': 'human eye metagenome',
        'taxon_id': '1774142',
        'host_body_habitat': 'UBERON:eye',
        'empo_3': 'Animal surface',
        'env_material': 'tears',
        'env_package': 'human-associated',
        'description': 'American Gut Project Tears sample',
        'host_body_site': 'UBERON:eye'},
    'Right hand': {
        'host_body_product': 'UBERON:sebum',
        ...
        'host_body_site': 'UBERON:skin of hand'},
    'Axilla': {
        'host_body_product': 'UBERON:sebum',
        'sample_type': 'Axilla',
        'scientific_name': 'human skin metagenome',
        ...
        'host_body_site': 'UBERON:skin of axilla'},
    'Torso': {
        'host_body_product': 'UBERON:sebum',
        'sample_type': 'Torso',
        'scientific_name': 'human skin metagenome',
        ...
        'host_body_site': 'UBERON:skin of trunk'},
    'Left leg': {
        'host_body_product': 'UBERON:sebum',
        ...
        'host_body_site': 'UBERON:skin of leg'},
    'Right leg': {
        'host_body_product': 'UBERON:sebum',
    ...
    'Left hand': {
        ...
        'host_body_site': 'UBERON:skin of hand'},
    'Ear wax': {
        'host_body_product': 'UBERON:cerumen',
        'sample_type': 'Ear wax',
        'scientific_name': 'human metagenome',
        'taxon_id': '646099',
        'host_body_habitat': 'UBERON:ear',
