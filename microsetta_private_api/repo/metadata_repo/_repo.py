...
# survey questions from Qiita for a set period of time. This list will need to
# be updated when that limitation is lifted.
EBI_REMOVE = [
    'ABOUT_YOURSELF_TEXT', 'ANTIBIOTIC_CONDITION',
    ...
    'SKIN_CONDITIONS_RECENT_ACNE_DIAGNOSED_HOW',
    'SKIN_CONDITIONS_RECENT_ROSACEA_ANTIBIOTICS',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_PIGMENTED_ACNE',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_PIMPLES_BREAKOUTS_BLEMISHES',
    'ACNE_MEDICATION_OTC',
    'FACIAL_SKIN_TYPE',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_REDNESS',
    'FACIAL_SKIN_TYPE_MENOPAUSE_20S',
    'SKIN_COLOR',
    'HOURS_PER_DAY_OUTDOORS_UNDER_18',
    'HOURS_PER_DAY_OUTDOORS_10AM_2PM',
    'SUNSCREEN_UNDER_SPF_50',
    'SUNSCREEN_OVER_SPF_50',
    'SKIN_REACTION_WITHOUT_SUNSCREEN',
    'FACIAL_SKIN_CURRENT_CONDITIONS',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_ACNE',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_BLACKHEADS',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_DARK_SPOTS',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_DEPIGMENTATION',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_DRY_SKIN',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_DULL_SKIN',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_FINE_LINES',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_HYPER_PIGMENTATION',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_LARGE_PORES',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_MOLES',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_OILY_SKIN',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_ROUGH_SKIN',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_SAGGING',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_SENSITIVE_SKIN',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_SHINY_SKIN',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_UNDER_EYE_BAGS',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_UNDER_EYE_CIRCLES',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_UNEVEN_SKIN_TONE',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_UNPREDICTABLE_SKIN',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_UNWANTED_FACIAL_HAIR',
    'FACIAL_SKIN_CURRENT_CONDITIONS_SEVERITY_WRINKLES',
    'SCALP_CURRENT_CONDITIONS',
    'SCALP_CURRENT_CONDITIONS_SEVERITY_HAIR_LOSS',
    'SCALP_CURRENT_CONDITIONS_SEVERITY_DANDRUFF',
    'SCALP_CURRENT_CONDITIONS_SEVERITY_DRY_SCALP',
    'SCALP_CURRENT_CONDITIONS_SEVERITY_ITCHY_SCALP',
    'FACIAL_PRODUCTS_USED_REGULARLY',
    'FACIAL_PROCEDURES_LAST_SIX_MONTHS',
    'FACIAL_DEVICES_AT_HOME_LAST_SIX_MONTHS',
    'SKIN_CONDITIONS_RECENT_ACNE',
    'SKIN_CONDITIONS_RECENT_ACNE_BODY_SITES',
    'SKIN_CONDITIONS_RECENT_ACNE_ONSET',
    'SKIN_CONDITIONS_RECENT_ACNE_PRESCRIPTIONS',
    'SKIN_CONDITIONS_RECENT_ACNE_ANTIBIOTICS',
    'SKIN_CONDITIONS_RECENT_ACNE_TOPICAL_TREATMENTS',
    'SKIN_CONDITIONS_RECENT_ACNE_CURRENT_SYMPTOMS',
    'SKIN_CONDITIONS_RECENT_ACNE_SEVERITY',
    'SKIN_CONDITIONS_RECENT_ACNE_LAST_EXPERIENCED',
    'SKIN_CONDITIONS_RECENT_ACNE_FACTORS',
    'SKIN_CONDITIONS_RECENT_ACNE_FACTORS_SEASONS_WHICH',
    'SKIN_CONDITIONS_RECENT_ACNE_FACTORS_SEASONS_SEVERITY',
    'SKIN_CONDITIONS_RECENT_ACNE_FACTORS_MENSTRUATION_TIMING',
    'SKIN_CONDITIONS_RECENT_ACNE_FACTORS_MENSTRUATION_SEVERITY',
    'SKIN_CONDITIONS_RECENT_ATOPIC_DERMATITIS',
    'SKIN_CONDITIONS_RECENT_ATOPIC_DERMATITIS_DIAGNOSED_HOW',
    'SKIN_CONDITIONS_RECENT_ATOPIC_DERMATITIS_BODY_SITES',
    'SKIN_CONDITIONS_RECENT_ATOPIC_DERMATITIS_ONSET',
    'SKIN_CONDITIONS_RECENT_ATOPIC_DERMATITIS_PRESCRIPTIONS',
    'SKIN_CONDITIONS_RECENT_ATOPIC_DERMATITIS_ANTIBIOTICS',
    'SKIN_CONDITIONS_RECENT_ATOPIC_DERMATITIS_TOPICAL_TREATMENTS',
    'SKIN_CONDITIONS_RECENT_ATOPIC_DERMATITIS_CURRENT_SYMPTOMS',
    'SKIN_CONDITIONS_RECENT_ATOPIC_DERMATITIS_SEVERITY',
    'SKIN_CONDITIONS_RECENT_ATOPIC_DERMATITIS_LAST_EXPERIENCED',
    'SKIN_CONDITIONS_RECENT_ATOPIC_DERMATITIS_FACTORS',
    'SKIN_CONDITIONS_RECENT_ATOPIC_DERMATITIS_FACTORS_SEASONS_WHICH',
    'SKIN_CONDITIONS_RECENT_ATOPIC_DERMATITIS_FACTORS_SEASONS_SEVERITY',
    'SKIN_CONDITIONS_RECENT_ATOPIC_DERMATITIS_FACTORS_MENSTRUATION_TIMING',
    'SKIN_CONDITIONS_RECENT_ATOPIC_DERMATITIS_FACTORS_MENSTRUATION_SEVERITY',
    'SKIN_CONDITIONS_RECENT_PSORIASIS',
    'SKIN_CONDITIONS_RECENT_PSORIASIS_DIAGNOSED_HOW',
    'SKIN_CONDITIONS_RECENT_PSORIASIS_BODY_SITES',
    'SKIN_CONDITIONS_RECENT_PSORIASIS_ONSET',
    'SKIN_CONDITIONS_RECENT_PSORIASIS_PRESCRIPTIONS',
    'SKIN_CONDITIONS_RECENT_PSORIASIS_ANTIBIOTICS',
    'SKIN_CONDITIONS_RECENT_PSORIASIS_TOPICAL_TREATMENTS',
    'SKIN_CONDITIONS_RECENT_PSORIASIS_CURRENT_SYMPTOMS',
    'SKIN_CONDITIONS_RECENT_PSORIASIS_SEVERITY',
    'SKIN_CONDITIONS_RECENT_PSORIASIS_LAST_EXPERIENCED',
    'SKIN_CONDITIONS_RECENT_PSORIASIS_FACTORS',
    'SKIN_CONDITIONS_RECENT_PSORIASIS_FACTORS_SEASONS_WHICH',
    'SKIN_CONDITIONS_RECENT_PSORIASIS_FACTORS_SEASONS_SEVERITY',
    'SKIN_CONDITIONS_RECENT_PSORIASIS_FACTORS_MENSTRUATION_TIMING',
    'SKIN_CONDITIONS_RECENT_PSORIASIS_FACTORS_MENSTRUATION_SEVERITY',
    'SKIN_CONDITIONS_RECENT_ROSACEA',
    'SKIN_CONDITIONS_RECENT_ROSACEA_DIAGNOSED_HOW',
    'SKIN_CONDITIONS_RECENT_ROSACEA_BODY_SITES',
    'SKIN_CONDITIONS_RECENT_ROSACEA_ONSET',
    'SKIN_CONDITIONS_RECENT_ROSACEA_PRESCRIPTIONS',
    'SKIN_CONDITIONS_RECENT_ROSACEA_TOPICAL_TREATMENTS',
    'SKIN_CONDITIONS_RECENT_ROSACEA_CURRENT_SYMPTOMS',
    'SKIN_CONDITIONS_RECENT_ROSACEA_SEVERITY',
    'SKIN_CONDITIONS_RECENT_ROSACEA_LAST_EXPERIENCED',
    'SKIN_CONDITIONS_RECENT_ROSACEA_FACTORS',
    'SKIN_CONDITIONS_RECENT_ROSACEA_FACTORS_SEASONS_WHICH',
    'SKIN_CONDITIONS_RECENT_ROSACEA_FACTORS_SEASONS_SEVERITY',
    'SKIN_CONDITIONS_RECENT_ROSACEA_FACTORS_MENSTRUATION_TIMING',
    'SKIN_CONDITIONS_RECENT_ROSACEA_FACTORS_MENSTRUATION_SEVERITY',
    'SKIN_CONDITIONS_RECENT_SEBORRHEIC_DERMATITIS',
    'SKIN_CONDITIONS_RECENT_SEBORRHEIC_DERMATITIS_DIAGNOSED_HOW',
    'SKIN_CONDITIONS_RECENT_SEBORRHEIC_DERMATITIS_BODY_SITES',
    'SKIN_CONDITIONS_RECENT_SEBORRHEIC_DERMATITIS_ONSET',
    'SKIN_CONDITIONS_RECENT_SEBORRHEIC_DERMATITIS_PRESCRIPTIONS',
    'SKIN_CONDITIONS_RECENT_SEBORRHEIC_DERMATITIS_ANTIFUNGALS',
    'SKIN_CONDITIONS_RECENT_SEBORRHEIC_DERMATITIS_TOPICAL_TREATMENTS',
    'SKIN_CONDITIONS_RECENT_SEBORRHEIC_DERMATITIS_CURRENT_SYMPTOMS',
    ...
    'SKIN_CONDITIONS_RECENT_SEBORRHEIC_DERMATITIS_FACTORS_SEASONS_SEVERITY',
    'SKIN_CONDITIONS_RECENT_SEBORRHEIC_DERMATITIS_FACTORS_MENSTRUATION_TIMING',
    'SKIN_CONDITIONS_RECENT_SEBORRHEIC_DERMATITIS_FACTORS_MENSTRUATION_SEVERITY',
    'SKIN_CONDITIONS_RECENT_VITILIGO',
    'SKIN_CONDITIONS_RECENT_VITILIGO_DIAGNOSED_HOW',
    'SKIN_CONDITIONS_RECENT_VITILIGO_BODY_SITES',
    'SKIN_CONDITIONS_RECENT_VITILIGO_ONSET',
    'SKIN_CONDITIONS_RECENT_VITILIGO_PRESCRIPTIONS',
    'SKIN_CONDITIONS_RECENT_VITILIGO_ANTIBIOTICS',
    'SKIN_CONDITIONS_RECENT_VITILIGO_TOPICAL_TREATMENTS',
    'SKIN_CONDITIONS_RECENT_VITILIGO_CURRENT_SYMPTOMS',
    'SKIN_CONDITIONS_RECENT_VITILIGO_SEVERITY',
    'SKIN_CONDITIONS_RECENT_VITILIGO_LAST_EXPERIENCED',
    'SKIN_CONDITIONS_RECENT_VITILIGO_FACTORS',
    'SKIN_CONDITIONS_RECENT_VITILIGO_FACTORS_SEASONS_WHICH',
    'SKIN_CONDITIONS_RECENT_VITILIGO_FACTORS_SEASONS_SEVERITY',
    'SKIN_CONDITIONS_RECENT_VITILIGO_FACTORS_MENSTRUATION_TIMING',
    'SKIN_CONDITIONS_RECENT_VITILIGO_FACTORS_MENSTRUATION_SEVERITY',
    'SKIN_CONDITIONS_RECENT_IMPETIGO',
    'SKIN_CONDITIONS_RECENT_IMPETIGO_BODY_SITES',
    'SKIN_CONDITIONS_RECENT_IMPETIGO_PRESCRIPTIONS',
    'SKIN_CONDITIONS_RECENT_IMPETIGO_ANTIBIOTICS',
    'SKIN_CONDITIONS_RECENT_IMPETIGO_TOPICAL_TREATMENTS',
    'SKIN_CONDITIONS_RECENT_CELLULITIS',
    'SKIN_CONDITIONS_RECENT_CELLULITIS_BODY_SITES',
    'SKIN_CONDITIONS_RECENT_CELLULITIS_PRESCRIPTIONS',
    'SKIN_CONDITIONS_RECENT_CELLULITIS_ANTIBIOTICS',
    'SKIN_CONDITIONS_RECENT_CELLULITIS_TOPICAL_TREATMENTS',
    'SKIN_CONDITIONS_RECENT_STAPH',
    'SKIN_CONDITIONS_RECENT_STAPH_BODY_SITES',
    'SKIN_CONDITIONS_RECENT_STAPH_PRESCRIPTIONS',
    'SKIN_CONDITIONS_RECENT_STAPH_ANTIBIOTICS',
    'SKIN_CONDITIONS_RECENT_STAPH_TOPICAL_TREATMENTS',
    'SKIN_CONDITIONS_RECENT_OTHER_BACTERIAL',
    'SKIN_CONDITIONS_RECENT_OTHER_BACTERIAL_BODY_SITES',
    'SKIN_CONDITIONS_RECENT_OTHER_BACTERIAL_PRESCRIPTIONS',
    'SKIN_CONDITIONS_RECENT_OTHER_BACTERIAL_ANTIBIOTICS',
    'SKIN_CONDITIONS_RECENT_OTHER_BACTERIAL_TOPICAL_TREATMENTS',
    'SKIN_CONDITIONS_RECENT_OTHER_FUNGAL',
    'SKIN_CONDITIONS_RECENT_OTHER_FUNGAL_BODY_SITES',
    'SKIN_CONDITIONS_RECENT_OTHER_FUNGAL_PRESCRIPTIONS',
    'SKIN_CONDITIONS_RECENT_OTHER_FUNGAL_ANTIBIOTICS',
    'SKIN_CONDITIONS_RECENT_OTHER_FUNGAL_TOPICAL_TREATMENTS',
    'SKIN_CONDITIONS_RECENT_VIRAL',
    'SKIN_CONDITIONS_RECENT_VIRAL_BODY_SITES',
    'SKIN_CONDITIONS_RECENT_VIRAL_PRESCRIPTIONS',
    'SKIN_CONDITIONS_RECENT_VIRAL_ANTIBIOTICS',
    'SKIN_CONDITIONS_RECENT_VIRAL_TOPICAL_TREATMENTS'
]
