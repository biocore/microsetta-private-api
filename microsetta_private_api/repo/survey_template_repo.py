    ...
    def get_survey_template(self, survey_id, language_tag):
        ...
        with self._transaction.cursor() as cur:
            ...
            for r in rows:
                ...
                # Quick and dirty fix to correctly sort country names in Spanish
                if language_tag == "es_MX" and (question_id == 110 or question_id == 148):
                    responses[1:len(responses)] = sorted(responses[1:len(responses)])
