...
CREATE INDEX source_address_composite ON ag.melissa_address_queries (source_address_1, source_address_2, source_postal, source_country);

CREATE INDEX result_address_composite ON ag.melissa_address_queries (result_address_1, result_address_2, result_postal, result_country);
