...
UPDATE barcodes.project SET is_microsetta='yes' WHERE is_microsetta IS NULL;
UPDATE barcodes.project SET is_microsetta='no' WHERE project in ('American Gut Project',
                                                                 'British Gut Project',
                                                                 'Daklapak W1',
                                                                 'canadian gut',
                                                                 'TMI - Daklapack W1',
