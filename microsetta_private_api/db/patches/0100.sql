...
(240, 'In a given week, how often do you use or cook with lard, butter or ghee?', 'In a given week, how often do you use or cook with lard, butter or ghee?', 'OILS_FREQUENCY_ANIMAL', 'En una semana determinada, ¿con qué frecuencia usa o cocina con manteca de cerdo, mantequilla o manteca?'),
...
(244, 'In a given week, how often do you consume soy products such as textured vegetable protein, tofu, tempeh, soybean flour, soy nuts, soy butter, soybeans, and miso (i.e. fermented soy)?', 'In a given week, how often do you consume soy products such as textured vegetable protein, tofu, tempeh, soybean flour, soy nuts, soy butter, soybeans, and miso (i.e. fermented soy)?', 'OILS_FREQUENCY_SOY', 'En una semana determinada, ¿con qué frecuencia consume productos de soja como proteína vegetal texturizada, tofu, tempeh, harina de soja, nueces de soja, mantequilla de soja, soja y miso (es decir, soja fermentada)?');
