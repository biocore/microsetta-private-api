...
def read_sample_vioscreen_session(account_id, source_id, sample_id, token_info):
    ...
    is_error, vioscreen_session = _get_session_by_account_details(account_id, source_id, sample_id)
    if is_error:
...
def read_sample_vioscreen_supplements(account_id, source_id, sample_id, token_info):
    _validate_account_access(token_info, account_id)
    ...
    with Transaction() as t:
        ...
        vioscreen_supplements = vio_supp.get_supplements(vioscreen_session[0].sessionId)
...
def read_sample_vioscreen_food_components(account_id, source_id, sample_id, token_info):
    _validate_account_access(token_info, account_id)
    ...
    with Transaction() as t:
        ...
        vioscreen_food_components = vio_food.get_food_components(vioscreen_session[0].sessionId)
...
def read_sample_vioscreen_eating_patterns(account_id, source_id, sample_id, token_info):
    _validate_account_access(token_info, account_id)
    ...
    with Transaction() as t:
        ...
        vioscreen_eating_patterns = vio_eat.get_eating_patterns(vioscreen_session[0].sessionId)
...
def read_sample_vioscreen_food_consumption(account_id, source_id, sample_id, token_info):
    _validate_account_access(token_info, account_id)
    ...
    with Transaction() as t:
        ...
        vioscreen_food_consumption = vio_cons.get_food_consumption(vioscreen_session[0].sessionId)
