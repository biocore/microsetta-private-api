...
def read_sample_vioscreen_session(account_id, source_id, token_info):
...
def read_sample_vioscreen_supplements(account_id, source_id, token_info):
    _validate_account_access(token_info, account_id)
...
def read_sample_vioscreen_food_components(account_id, source_id, token_info):
    _validate_account_access(token_info, account_id)
...
def read_sample_vioscreen_eating_patterns(account_id, source_id, token_info):
    _validate_account_access(token_info, account_id)
...
def read_sample_vioscreen_mpeds(account_id, source_id, token_info):
    _validate_account_access(token_info, account_id)
...
def read_sample_vioscreen_food_consumption(account_id, source_id, token_info):
    _validate_account_access(token_info, account_id)
